...
const templates = [
...

  {
    ...
    category: "Marketing",
    description: "Generate a professional lead magnet template for capturing emails with social media hooks and templates. AI-powered content generation.",
    image: "/placeholder.svg?height=300&width=400&text=Social+Media+Hooks",
    tags: ["AI", "Lead Magnet", "Social Media", "Premium"],
    isPremium: true,
    isLocked: false,
  },
