      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            No coding required. Choose from stunning templates, customize with our visual editor, and publish your site
            instantly. Perfect for portfolios, landing pages, and more.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">Drag, drop, and customize elements with our intuitive visual editor</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">Your sites look perfect on desktop, tablet, and mobile devices</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">Built with modern tech for blazing fast loading speeds</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">Publish and share your site with a single click</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of creators who have built beautiful websites with SiteBuilder
          </p>
          <Link href="/templates">
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 SiteBuilder. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
