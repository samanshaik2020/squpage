...
interface DentalHealthLandingTemplateProps {
  selectedElement: string | null
  onElementSelect: (elementId: string) => void
  isEditable: boolean
}

export function DentalHealthLandingTemplate({
  selectedElement,
  onElementSelect,
  isEditable,
}: DentalHealthLandingTemplateProps) {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <EditableElement
              ...
              defaultContent="The Simple 5-Second Habit for a Healthier Smile"
            ...
            <EditableElement
              ...
              onSelect={onElementSelect}
              defaultContent="Discover the science-backed way to support healthy teeth and gums — naturally."
              isEditable={isEditable}
            />
            <EditableElement
              id="hero-cta"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <EditableElement
              ...
              onSelect={onElementSelect}
              defaultContent="The Hidden Reason Your Teeth Aren't as Healthy as They Could Be"
              isEditable={isEditable}
            />
            <EditableElement
              id="problem-subtitle"
              ...
              onSelect={onElementSelect}
              defaultContent="A New Way to Support Oral Health From the Inside Out"
              isEditable={isEditable}
            />
            ...
            <div className="space-y-4 mb-8">
              {[
                "Helps balance good & bad bacteria in the mouth",
                "Supports gum health & fresh breath",
                "Uses natural, plant based ingredients",
                "Delicious chewable, easy to take daily"
              ].map((benefit, i) => (
            ...
            <Card className="bg-orange-100 p-8 max-w-sm">
              <CardContent className="p-0 text-center">
                ...
                <EditableElement
                  ...
                  onSelect={onElementSelect}
                  defaultContent="your mouth has over 700 types of bacteria — and not all of them are bad?"
                  isEditable={isEditable}
                />
              </CardContent>
            </Card>
